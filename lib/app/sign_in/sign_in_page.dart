import 'package:the_apple_sign_in/the_apple_sign_in.dart' as apple_button;
import 'package:poggit_ci/app/sign_in/developer_menu.dart';
import 'package:poggit_ci/app/sign_in/email_password/email_password_sign_in_page.dart';
import 'package:poggit_ci/app/sign_in/email_link/email_link_sign_in_page.dart';
import 'package:poggit_ci/app/sign_in/sign_in_manager.dart';
import 'package:poggit_ci/app/sign_in/social_sign_in_button.dart';
import 'package:poggit_ci/common_widgets/platform_exception_alert_dialog.dart';
...
class SignInPage extends StatelessWidget {
  ...
  static const Key appleButtonKey = Key('apple');
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            SocialSignInButton(
              ...
              color: Colors.white,
              textColor: Colors.black, // TODO(jason): change color?
            ),
            SizedBox(height: 8),
            SocialSignInButton(
            ...
            SignInButton(
              ...
              onPressed: () => _signInWithEmailLink(context),
              textColor: Colors.white,
